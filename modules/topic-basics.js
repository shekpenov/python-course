...
print(f"Через {18 - age} год(а) тебе исполнится 18")`
      ...
      task: {
        prompt: 'Дан вес в килограммах: <code>kg = 70</code>. Переведите в граммы (умножьте на 1000) и выведите: <em>«70 кг = 70000 г»</em>.',
        starterCode: `# ваш код здесь
`,
        solution: `kg = 70\ng = kg * 1000\nprint(f"{kg} кг = {g} г")`,
        hint: 'Умножьте <code>kg * 1000</code> и используйте f-строку для форматирования вывода.',
        test: (out, code) => out.trim() === '70 кг = 70000 г' && code.includes('*')
      }
    },
